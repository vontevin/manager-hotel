...
@section("content")
    <div class="right_col" role="main" style="margin-top: 100px">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <h3>{{ trans("menu.formcreate") }}</h3>
        </div>
        <div class="row">
            <div class="col-md-8 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><small>Create User Managerment</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ url('users') }}" method="POST">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <input type="text" name="name" class="form-control has-feedback-left" id="inputSuccess2" placeholder="{{trans('menu.name')}} ">
                                <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                            </div>
            
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <input type="text" name="email" class="form-control has-feedback-left" id="inputSuccess4" placeholder="{{trans('menu.email')}} ">
