    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><small>{{ trans('menu.viewGallery') }}</small></h2>
                    ...
                    <div class="x_content">
                        <div class="col-md-4 col-sm-3 col-xs-12 profile_left py-2">
                            ...
                            <div class="carousel-container">
                                <div class="carousel-images">
                                    <img src="{{ asset('storage/' . $gallery->image) }}" alt="{{ $gallery->name }}" class="img-fluid" />
                                </div>
                        ...
                        <div class="col-md-8 col-sm-9 col-xs-12">
                            <div class="x_content">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <h4 class="ff">{{ trans('menu.galleryDetails') }}</h4>
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <label for="name">{{ trans('menu.name') }}:</label>
                                    <input type="text" class="form-control" value="{{ $gallery->name }}" disabled>
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <label for="description">{{ trans('menu.description') }}:</label>
                                    <textarea style="height: 105px" class="form-control" id="description" disabled>{{ $gallery->description }}</textarea>
                                </div>

                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <label for="price">{{ trans('menu.price') }}:</label>
                                    <input type="text" class="form-control" value="{{ $gallery->price }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <div class="mb-3 pull-right">
                                    <a href="{{ route('galleries.index') }}" class="btn btn-primary"><i class="fa fa-close"></i>  {{ trans('menu.close') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
